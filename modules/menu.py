    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection:
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/Phantom-Tools"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/Basu-banakar/Phantom-Tools.git "+system.home+"/Phantom-Tools")
            if os.path.exists(system.home+"/Phantom-Tools/install.aex"):
              os.system("cd "+system.home+"/Phantom-Tools && "+system.sudo+" sh install.aex")
            ...
            if os.path.exists(system.home+"/Phantom-Tools"):
              ...
              os.system("git clone https://github.com/Basu-banakar/Phantom-Tools.git "+system.home+"/Phantom-Tools")
            if os.path.exists(system.home+"/Phantom-Tools/install.aex"):
              os.system("cd "+system.home+"/Phantom-Tools && sh install.aex")
              if os.path.exists(system.bin+"/Phantom-Tools") and os.path.exists(system.conf_dir+"/Phantom-Tools"):
                os.system("clear")
                logo.updated()
                cmd=input("\033[1;36m ##> \033[00m")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall Phantom-Tools" or cmd=="unistall Phantom-Tools":
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/Phantom-Tools")
          os.system(system.sudo+" rm -rf "+system.bin+"/phantomtool")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/Phantom-Tools")
        else:
          os.system("rm -rf "+system.bin+"/Phantom-Tools")
          os.system("rm -rf "+system.bin+"/phantomtool")
          os.system("rm -rf "+system.conf_dir+"/Phantom-Tools")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/Phantom-Tools/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/Phantom-Tools/core/cat.json") as cat_file:
